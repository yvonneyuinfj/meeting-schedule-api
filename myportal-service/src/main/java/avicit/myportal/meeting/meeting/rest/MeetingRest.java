 ...
 */
@RestController
@Api(tags = "meeting", description = "会议日程信息表")
...
public class MeetingRest implements CommonRestInstanceDeleteEventListener {
    ...
    public ResponseMsg<QueryRespBean<MeetingDTO>> searchByPage(@ApiParam(value = "分页", name = "queryReqBean") @RequestBody QueryReqBean<MeetingDTO> queryReqBean) {
    ...
    public ResponseMsg<List<MeetingDTO>> search(@ApiParam(value = "分页", name = "queryReqBean") @RequestBody QueryReqBean<MeetingDTO> queryReqBean) {
    ...
    @ApiOperation(value = "按条件不分页查询日程数据")
    public ResponseMsg<List<MeetingDTO>> getList(@ApiParam(value = "分页", name = "queryReqBean") @RequestBody QueryReqBean<MeetingDTO> queryReqBean) {
        ResponseMsg<List<MeetingDTO>> responseMsg = new ResponseMsg<>();
        List<MeetingDTO> result = meetingService.getMeetingList(queryReqBean);
        responseMsg.setResponseBody(result);
        return responseMsg;
    }
    ...
    @RequiresPermissions("meeting:view")
    public ResponseMsg<MeetingDTO> getById(@ApiParam(value = "主键id", name = "id") @PathVariable("id") String id) {
    ...
    public ResponseMsg<Integer> updateSensitive(@ApiParam(value = "更新对象", name = "meeting") @RequestBody MeetingDTO meeting) {
    ...
    public void exportData(@ApiParam(value = "查询条件", name = "queryReqBean") @RequestBody QueryReqBean<MeetingDTO> queryReqBean, HttpServletResponse response) throws IOException {
        List<MeetingDTO> list = meetingService.searchMeetingForExportExcel(queryReqBean, ThreadContextHelper.getOrgId(), new ArrayList<String>(), queryReqBean.getSortExp());
        //        // 输出
